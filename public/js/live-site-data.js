(function () {
  ...
  function renderNote(note) {
    return `
      <article
        ...
        data-note-category="${attr(note.category)}"
        data-note-search="${attr(`${note.title} ${note.category} ${note.excerpt} ${note.meta}`)}"
      >
  ...
  function updateNotesPage(data) {
    ...
    window.__initializeNotesSearch?.();
